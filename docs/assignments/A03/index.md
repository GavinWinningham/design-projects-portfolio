...
## Design Reflection / Lessons Learned
...
B.
When taking into account a hole placed on my object, I utilized the equation Stress Peak = Kt * Stress Norm. After looking up the stress concentration factor for a hole in tension, this being Kt = 2.17, I then plugged in the stress I got from the simulation and got a peak stress of 18,900 PSI. When plugged into the FOS equation, utilizing the strength of aluminum value given in the project of 40,000 PSI, I got an FOS of 2.12, thus this passes the test.

From this project, some of the lessons I learned were utilizing exact values in calculations. For example, with the modulus of elasticity, I utilized a slightly different value than that of SolidWorks and got a percent difference in deflection of 0.18%. More than likely, this percent difference is from not utilizing exact values and rounding errors. Another thing I learned was how to run simulations in CAD, specifically with SolidWorks.
